-- ============================================================
--  FIX FINAL — Apagar políticas existentes e recriar tudo
-- ============================================================

-- PASSO 1: Apagar políticas apenas nas tabelas que existem
...
-- PASSO 2: Criar tabelas novas (que ainda não existem)
...
-- PASSO 3: Adicionar colunas novas às tabelas existentes
...
-- PASSO 4: Ativar RLS nas tabelas novas
alter table teams          enable row level security;
alter table treatments     enable row level security;
alter table nutrition_plans enable row level security;

-- PASSO 5: Recriar TODAS as políticas
